...
function Task(id, title, description, user, date) {
    ...
    const taskTitle = createElement('p', { className: 'task-title', textContent: this.title });
    const taskEdit = createElement('button', { className: 'task-edit', textContent: 'Редактировать' });
    const taskDelete = createElement('button', { className: 'task-delete', textContent: 'Удалить' });
    const taskDescription = createElement('p', { className: 'task-description', textContent: this.description });
    const taskUser = createElement('p', { className: 'task-text', textContent: this.user });
    const taskArrow = createElement('div', { className: 'task-arrow' });
    taskArrow.innerHTML = `<i class="fa-solid fa-arrow-right"></i>`
    const taskDate = createElement('p', { className: 'task-text', textContent: this.date });
    ...
    const taskBottomRight = createElement('div', { className: 'task-bottom__right' });
